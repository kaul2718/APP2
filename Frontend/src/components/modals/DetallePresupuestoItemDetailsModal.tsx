...
export default function DetallePresupuestoItemDetailsModal({ isOpen, onClose, detalle }: Props) {
      ...
      <div className="px-6 py-4 space-y-8 text-sm">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
            ...
            <InputDisplay
              label="Ítem / Parte"
              value={detalle.parte?.nombre || "No disponible"}
              icon={
                <Icon>
            ...
            <InputDisplay
              ...
              value={detalle.parte?.codigoInterno || "No disponible"}
              icon={
                <Icon>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
