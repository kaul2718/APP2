...
export default function TipoNotificacionDetailsModal({ isOpen, onClose, tipo }: Props) {
  if (!tipo) return null;
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title="Detalles del Tipo de Notificación"
      ...
      <div className="px-6 py-4 space-y-8 text-sm">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
            ...
            <InputDisplay
              label="Descripción"
              value={tipo.descripcion || "Sin descripción"}
              icon={
                <Icon>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        <section>
          ...
          <div className="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
            <InputDisplay
              label="Notificaciones asociadas"
              value={tipo.notificaciones?.length || 0}
              icon={
                <Icon>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
