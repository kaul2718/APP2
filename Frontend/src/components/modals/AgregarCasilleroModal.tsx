...
export default function AgregarCasilleroModal({ isOpen, onClose, onSuccess }: Props) {
  const handleSuccess = () => {
    onSuccess?.();
    onClose();
  };
    ...
    >
      <div className="px-6 pt-4 pb-6">
        ...
        <div className="custom-scrollbar max-h-[75vh] overflow-y-auto pr-1">
          <IngresarCasilleroForm embeddedMode onSuccess={handleSuccess} onClose={onClose} />
        </div>
      </div>
    </Modal>
  );
