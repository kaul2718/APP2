...
export default function EspecificacionDetailsModal({ 
  isOpen, 
  onClose, 
  especificacion 
}: Props) {
  ...
  const fechaCreacion = new Date(especificacion.createdAt).toLocaleDateString();
  const fechaActualizacion = new Date(especificacion.updatedAt).toLocaleDateString();
  const fechaEliminacion = especificacion.deletedAt 
    ? new Date(especificacion.deletedAt).toLocaleDateString() 
    : "No eliminado";
      ...
      <div className="px-6 py-4 space-y-8 text-sm">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-2">
            ...
            <InputDisplay
              label="Parte"
              value={especificacion.parte?.nombre || "Sin parte"}
              icon={
                <Icon>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <InputDisplay
              ...
              value={especificacion.tipoEspecificacion?.nombre || "Sin tipo"}
              icon={
                <Icon>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
